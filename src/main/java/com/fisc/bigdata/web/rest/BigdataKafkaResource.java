...
@RestController
@RequestMapping("/api/bigdata-kafka")
public class BigdataKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BigdataKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BigdataKafkaResource(KafkaProperties kafkaProperties) {
